...
from Mylayers import MaxPoolingWithArgmax2D, MaxUnpooling2D, basic_unpool2d
...
def CreateSegNet(input_shape, kernel=3, pool_size=(2, 2), output_mode="softmax", inputz=None):
    # encoder
